...
import (
	...
	"github.com/luigi-pizza/wasaPhoto/service/api"
	"github.com/luigi-pizza/wasaPhoto/service/database"
...
func run() error {
	...
	if _, err := os.Stat(filesystem.FileSystemPath); os.IsNotExist(err) {
		err := os.MkdirAll(filesystem.FileSystemPath, 0755)
		if err != nil {
			return err
		}
	} else if err != nil {
